...
#
# Example Usage: 
# ESMINI_BUILD_INSTALL_PREFIX=~/pb ESMINI_BUILD_OSI_VERSION=3.15.2 protobuf-install.sh
...
ESMINI_BUILD_OSI_VERSION=${ESMINI_BUILD_OSI_VERSION:-3.7.0}

git clone "${ESMINI_BUILD_OSI_SOURCE_REPOSITORY_URL}" ${ESMINI_BUILD_OSI_SOURCE_DIR} \
  --depth 1 \
  --branch "v${ESMINI_BUILD_OSI_VERSION}" \
  --recurse-submodules
cmake \
